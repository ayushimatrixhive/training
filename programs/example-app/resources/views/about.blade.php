    ...
    <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
            ...
            <div class="col-lg-6 left-wthree-img mt-lg-0 mt-sm-5 mt-4">
                <img src="{{ asset('images/about.jpg') }}" alt="" class="img-fluid radius-image">
    ...
    <div class="container py-lg-5 py-md-3">
        <div class="row">
            ...
            <div class="col-lg-3 col-6 left-wthree-img mt-lg-0 mt-sm-5 mt-4">
                <img src="{{ asset('images/about1.jpg') }}" alt="" class="img-fluid radius-image">
            </div>
            <div class="col-lg-3 col-6  left-wthree-img mt-lg-0 mt-sm-5 mt-4">
                <img src="{{ asset('images/about2.jpg') }}" alt="" class="img-fluid radius-image">
            </div>
        </div>
    </div>
</section>
